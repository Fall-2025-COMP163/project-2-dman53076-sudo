...
class Player(Character):
    ...
    def display_stats(self):
        ...
        super().display_stats()
        print(f"{'Class:':<10} {self.character_class}")
        print(f"{'Level:':<10} {self.level}")
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        import random
        if random.randint(1, 10) <= 3:  # 30% chance for critical hit
...
if __name__ == "__main__":
    ...
    warrior = Warrior("Cid Kagenou")
    mage = Mage("Ainz Ooal Gown")
    rogue = Rogue("Kazuma Satou")
